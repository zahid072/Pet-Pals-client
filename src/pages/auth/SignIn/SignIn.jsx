...
const SignIn = () => {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-blue-gray-100">
      ...
      <div className=" bg-white p-6 rounded-lg lg:w-2/5">
              <form onSubmit={handleSubmit(handleSignIn)} className="space-y-3 flex flex-col gap-4">
                ...
                <div className=" mt-6">
                  <button className=" w-full px-4 py-2 rounded-lg bg-[#573f7f] hover:bg-[#7a548f] text-white text-xl ">
                    Sign In
                  </button>
                </div>
              </form>
