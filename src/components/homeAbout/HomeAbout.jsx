...
const HomeAbout = () => {
  return (
    <div>
      ...
      <div className="bg-white  rounded-lg shadow-lg max-w-6xl mx-auto mt-10 flex md:flex-row flex-col items-center">
      <div className='md:w-3/5 w-full bg-blue-gray-200/40 p-6'>
      ...
      <div className=' md:w-2/5 w-full h-full space-y-6'>
      <div><h2 className='text-center font-semibold font-baloo text-3xl'>Connect With Us</h2></div>
